...
typedef Scene = {
	...
	var isMobile : Bool;
	var object3D : three.Scene;
	var renderer : three.WebGLRenderer;
	var renderStarted : Bool;
	@:optional
	var effect : Dynamic;
	var systems : ObjectMap<System<Dynamic>>;
	var time : Float;
	function enterVR():ts.AnyOf2<ts.Undefined, js.lib.Promise<ts.Undefined>>;
	function exitVR():ts.AnyOf2<ts.Undefined, js.lib.Promise<ts.Undefined>>;
	...
	/**
		...
		The event listener is appended to target's event listener list and is not appended if it has the same type, callback, and capture.
	**/
	@:overload(function(type:SceneEvents, listener:js.html.EventListener, ?useCapture:Bool):Void { })
	function addEventListener(type:String, listener:js.html.EventListenerOrEventListenerObject, ?useCapture:Bool):Void;
	var components : Dynamic;
	var hasLoaded : Bool;
	var isPlaying : Bool;
	var object3DMap : ObjectMap<three.Object3D<three.Event>>;
	@:optional
	var sceneEl : Scene;
	function destroy():Void;
	function addState(name:String):Void;
	function flushToDOM(?recursive:Bool):Void;
	function getComputedAttribute(attr:String):Component<Dynamic, System<Dynamic>>;
	function getDOMAttribute(attr:String):Dynamic;
	function getObject3D(type:String):three.Object3D<three.Event>;
	function getOrCreateObject3D(type:String, construct:Dynamic):three.Object3D<three.Event>;
	function is(stateName:String):Bool;
	function pause():Void;
	function play():Void;
	function setObject3D(type:String, obj:three.Object3D<three.Event>):Void;
	/**
		Removes element's first attribute whose qualified name is qualifiedName.
	**/
	function removeAttribute(attr:String, ?property:String):Void;
	function removeObject3D(type:String):Void;
	...
	/**
		...
		Returns element's first attribute whose qualified name is qualifiedName, and null if there is no such attribute otherwise.
	**/
	@:overload(function(type:String):Coordinate { })
	function getAttribute(type:String):Dynamic;
	/**
		...
		Sets the value of element's first attribute whose qualified name is qualifiedName to value.
	**/
	@:overload(function(attr:String, property:String, ?componentAttrValue:Dynamic):Void { })
	@:overload(function(type:String, value:Coordinate):Void { })
	function setAttribute(attr:String, value:Dynamic):Void;
	function closestScene():Scene;
	/**
		Returns the first (starting at element) inclusive ancestor that matches selectors, and null otherwise.
	**/
	function closest(selector:String):ANode;
	function load(?cb:() -> Void, ?childFilter:(el:js.html.DOMElement) -> Bool):Void;
	function registerMixin(id:String):Void;
	function unregisterMixin(id:String):Void;
	function removeMixinListener(id:String):Void;
	function attachMixinListener(mixin:js.html.Element):Void;
	function emit(name:String, ?detail:Dynamic, ?bubbles:Bool):Void;
	function emitter(name:String, ?detail:Dynamic, ?bubbles:Bool):() -> Void;
	...
	**/
	function getElementsByClassName(classNames:String):js.html.HTMLCollectionOf<js.html.DOMElement>;
	@:overload(function<K>(qualifiedName:K):js.html.HTMLCollectionOf<Dynamic> { })
	@:overload(function(qualifiedName:String):js.html.HTMLCollectionOf<js.html.DOMElement> { })
	function getElementsByTagName<K>(qualifiedName:K):js.html.HTMLCollectionOf<Dynamic>;
	@:overload(function(namespaceURI:String, localName:String):js.html.HTMLCollectionOf<js.html.svg.Element> { })
	@:overload(function(namespaceURI:String, localName:String):js.html.HTMLCollectionOf<js.html.DOMElement> { })
	function getElementsByTagNameNS(namespaceURI:String, localName:String):js.html.HTMLCollectionOf<js.html.Element>;
	/**
	...
	**/
	...
	function insertAdjacentElement(position:js.html.InsertPosition, insertedElement:js.html.DOMElement):Null<js.html.DOMElement>;
	function insertAdjacentHTML(where:js.html.InsertPosition, html:String):Void;
	function insertAdjacentText(where:js.html.InsertPosition, text:String):Void;
	/**
	...
	**/
	final childNodes : js.html.NodeListOf<js.html.ChildNode>;
	/**
	...
	**/
	...
	function animate(keyframes:Null<ts.AnyOf2<Array<js.html.Keyframe>, js.html.PropertyIndexedKeyframes>>, ?options:ts.AnyOf2<Float, js.html.KeyframeAnimationOptions>):js.html.Animation;
	...
	**/
	@:overload(function<K>(selectors:K):js.html.NodeListOf<Dynamic> { })
	@:overload(function<E>(selectors:String):js.html.NodeListOf<E> { })
	function querySelectorAll<K>(selectors:K):js.html.NodeListOf<Dynamic>;
	@:optional
