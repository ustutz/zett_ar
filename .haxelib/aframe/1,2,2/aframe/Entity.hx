...
typedef Entity<C> = {
	...
	var hasLoaded : Bool;
	var isPlaying : Bool;
	var object3D : three.Object3D<three.Event>;
	...
	**/
	...
	/**
		...
		The event listener is appended to target's event listener list and is not appended if it has the same type, callback, and capture.
	**/
	@:overload(function(type:String, listener:js.html.EventListenerOrEventListenerObject, ?useCapture:Bool):Void { })
	function addEventListener<K>(type:K, listener:(event:Dynamic) -> Void, ?useCapture:Bool):Void;
