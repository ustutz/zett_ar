...
typedef AFrame = {
	var AComponent : Component<Dynamic, System<Dynamic>>;
	var AEntity : Entity<ObjectMap<Component<Dynamic, System<Dynamic>>>>;
	var ANode : ANode;
	var AScene : Scene;
	var components : ObjectMap<ComponentDescriptor<Component<Dynamic, System<Dynamic>>>>;
	var geometries : ObjectMap<GeometryDescriptor<Geometry<Dynamic>>>;
	var primitives : {
		...
		var primitives : ObjectMap<Entity<ObjectMap<Component<Dynamic, System<Dynamic>>>>>;
	};
	var scenes : Array<Scene>;
	var schema : SchemaUtils;
	var shaders : ObjectMap<ShaderDescriptor<Shader>>;
	var systems : ObjectMap<SystemConstructor<Dynamic>>;
	var THREE : {
	...
	var utils : Utils;
	var version : String;
	function registerComponent<T>(name:String, component:ComponentDefinition<T>):ComponentConstructor<T>;
	function registerElement(name:String, element:Dynamic):Void;
	function registerGeometry<T>(name:String, geometry:GeometryDefinition<T, Dynamic>):GeometryConstructor<T>;
	function registerPrimitive(name:String, primitive:PrimitiveDefinition):Void;
	function registerShader<T>(name:String, shader:ShaderDefinition<T>):ShaderConstructor<T>;
	function registerSystem<T>(name:String, definition:SystemDefinition<T>):SystemConstructor<T>;
};