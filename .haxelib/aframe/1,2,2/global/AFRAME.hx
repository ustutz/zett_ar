...
@:native("AFRAME") @valueModuleOnly extern class AFRAME {
	...
	static final THREE : {
		...
		**/
		...
		final DefaultLoadingManager : global.three.LoadingManager;
		final LoaderUtils : global.three.LoaderUtils;
		var ShaderLib : {
		...
		function cloneUniformsGroups(src:Array<global.three.UniformsGroup>):Array<global.three.UniformsGroup>;
		final ShaderChunk : {
		...
		function WebGLUniformsGroups(gl:js.html.webgl.RenderingContext, info:global.three.WebGLInfo, capabilities:global.three.WebGLCapabilities, state:global.three.WebGLState):{
	...
	static final ANIME : {
		@:selfCall
		function call(params:global.anime.AnimeParams):global.anime.AnimeInstance;
		...
		function stagger(value:ts.AnyOf3<String, Float, haxe.ds.ReadOnlyArray<ts.AnyOf2<String, Float>>>, ?options:global.anime.StaggerOptions):animejs.FunctionBasedParameter;
		function set(targets:animejs.AnimeTarget, value:haxe.DynamicAccess<Dynamic>):Void;
		function timeline(?params:ts.AnyOf2<global.anime.AnimeParams, haxe.ds.ReadOnlyArray<global.anime.AnimeInstance>>):global.anime.AnimeTimelineInstance;
		function random(min:Float, max:Float):Float;
		final version : String;
		final speed : Float;
		final running : Array<global.anime.AnimeInstance>;
