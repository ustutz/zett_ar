...
@:jsRequire("three", "WebGLCubeRenderTarget") extern class WebGLCubeRenderTarget extends WebGLRenderTarget<Texture> {
	...
	function copy(source:WebGLRenderTarget<Texture>):WebGLCubeRenderTarget;
	/**
