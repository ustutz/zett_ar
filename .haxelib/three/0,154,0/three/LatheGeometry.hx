...
**/
@:jsRequire("three", "LatheGeometry") extern class LatheGeometry extends BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>> {
	/**
