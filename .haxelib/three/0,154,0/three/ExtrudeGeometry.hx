...
**/
@:jsRequire("three", "ExtrudeGeometry") extern class ExtrudeGeometry extends BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>> {
	/**
