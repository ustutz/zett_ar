...
**/
@:jsRequire("three", "CylinderGeometry") extern class CylinderGeometry extends BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>> {
	/**
