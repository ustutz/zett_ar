...
**/
@:jsRequire("three", "CapsuleGeometry") extern class CapsuleGeometry extends BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>> {
	/**
