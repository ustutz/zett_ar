...
**/
@:jsRequire("three", "EdgesGeometry") extern class EdgesGeometry<TBufferGeometry> extends BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>> {
	/**
