...
**/
@:jsRequire("three", "GridHelper") extern class GridHelper extends LineSegments<BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>>, LineBasicMaterial> {
	/**
