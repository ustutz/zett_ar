...
@:jsRequire("three/src/renderers/webgl/WebGLBindingStates", "WebGLBindingStates") extern class WebGLBindingStates {
	...
	function setup(object:three.Object3D<three.Event>, material:three.Material, program:three.WebGLProgram, geometry:three.BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<three.BufferAttribute, three.InterleavedBufferAttribute>>>, index:three.BufferAttribute):Void;
	function reset():Void;
