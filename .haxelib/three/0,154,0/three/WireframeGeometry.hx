...
**/
@:jsRequire("three", "WireframeGeometry") extern class WireframeGeometry<TBufferGeometry> extends BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>> {
	/**
	...
	**/
	function copy(source:BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>>):WireframeGeometry<TBufferGeometry>;
	/**
