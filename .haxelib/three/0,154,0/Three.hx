@:jsRequire("three") @valueModuleOnly extern class Three {
	...
	**/
	...
	static function cloneUniformsGroups(src:Array<three.UniformsGroup>):Array<three.UniformsGroup>;
	...
	static function WebGLUniformsGroups(gl:js.html.webgl.RenderingContext, info:three.WebGLInfo, capabilities:three.WebGLCapabilities, state:three.WebGLState):{
