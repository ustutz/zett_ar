...
**/
@:native("THREE.PolyhedronGeometry") extern class PolyhedronGeometry extends BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>> {
	/**
