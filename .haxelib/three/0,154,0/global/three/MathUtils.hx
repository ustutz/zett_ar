...
@:native("THREE.MathUtils") @valueModuleOnly extern class MathUtils {
	...
	**/
	...
	static final MathUtils : {
		...
		dynamic function setQuaternionFromProperEuler(q:Quaternion, a:Float, b:Float, c:Float, order:String):Void;
