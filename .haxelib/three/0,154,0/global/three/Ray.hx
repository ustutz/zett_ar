...
@:native("THREE.Ray") extern class Ray {
	...
	function intersectSphere(sphere:Sphere, target:Vector3):Null<Vector3>;
	function intersectsSphere(sphere:Sphere):Bool;
	function distanceToPlane(plane:Plane):Float;
	function intersectPlane(plane:Plane, target:Vector3):Null<Vector3>;
	function intersectsPlane(plane:Plane):Bool;
	function intersectBox(box:Box3, target:Vector3):Null<Vector3>;
	function intersectsBox(box:Box3):Bool;
	function intersectTriangle(a:Vector3, b:Vector3, c:Vector3, backfaceCulling:Bool, target:Vector3):Null<Vector3>;
