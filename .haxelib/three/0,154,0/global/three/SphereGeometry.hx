...
**/
@:native("THREE.SphereGeometry") extern class SphereGeometry extends BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>> {
	/**
