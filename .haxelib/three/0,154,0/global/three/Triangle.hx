...
@:native("THREE.Triangle") extern class Triangle {
	...
	@:overload(function(point:Vector3, p1:Vector3, p2:Vector3, p3:Vector3, v1:Vector3, v2:Vector3, v3:Vector3, target:Vector3):Vector3 { })
	@:overload(function(point:Vector3, p1:Vector3, p2:Vector3, p3:Vector3, v1:Vector4, v2:Vector4, v3:Vector4, target:Vector4):Vector4 { })
	@:native("getInterpolation")
	static function getInterpolation_(point:Vector3, p1:Vector3, p2:Vector3, p3:Vector3, v1:Vector2, v2:Vector2, v3:Vector2, target:Vector2):Vector2;
