...
**/
@:native("THREE.WireframeGeometry") extern class WireframeGeometry<TBufferGeometry> extends BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>> {
	/**
