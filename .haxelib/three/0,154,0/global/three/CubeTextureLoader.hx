...
@:native("THREE.CubeTextureLoader") extern class CubeTextureLoader extends Loader {
	...
	function loadAsync(urls:Array<String>, ?onProgress:(event:js.html.ProgressEvent_<js.html.EventTarget>) -> Void):js.lib.Promise<CubeTexture>;
