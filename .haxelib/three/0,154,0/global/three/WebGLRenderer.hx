...
@:native("THREE.WebGLRenderer") extern class WebGLRenderer {
	...
	**/
	...
	function clearTarget(renderTarget:WebGLRenderTarget<Texture>, color:Bool, depth:Bool, stencil:Bool):Void;
	function resetGLState():Void;
	function dispose():Void;
	function renderBufferDirect(camera:Camera, scene:Scene, geometry:BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>>, material:Material, object:Object3D<Event>, geometryGroup:Dynamic):Void;
	/**
	...
	**/
	function getRenderTarget():Null<WebGLRenderTarget<Texture>>;
	function getCurrentRenderTarget():Null<WebGLRenderTarget<Texture>>;
	/**
		Sets the active render target.
	**/
	function setRenderTarget(renderTarget:Null<ts.AnyOf2<WebGLRenderTarget<Texture>, WebGLMultipleRenderTargets>>, ?activeCubeFace:Float, ?activeMipmapLevel:Float):Void;
	function readRenderTargetPixels(renderTarget:ts.AnyOf2<WebGLRenderTarget<Texture>, WebGLMultipleRenderTargets>, x:Float, y:Float, width:Float, height:Float, buffer:Dynamic, ?activeCubeFaceIndex:Float):Void;
	/**
	...
	**/
	function copyTextureToTexture3D(sourceBox:Box3, position:Vector3, srcTexture:Texture, dstTexture:ts.AnyOf2<Data3DTexture, DataArrayTexture>, ?level:Float):Void;
	/**
