...
@:native("THREE.WebGLState") extern class WebGLState {
	...
	function setBlending(blending:Blending, ?blendEquation:BlendingEquation, ?blendSrc:Int, ?blendDst:BlendingDstFactor, ?blendEquationAlpha:BlendingEquation, ?blendSrcAlpha:Int, ?blendDstAlpha:BlendingDstFactor, ?premultiplyAlpha:Bool):Void;
